...
python DataGen/RLTrainFidIndHpc.py -idx $SLURM_ARRAY_TASK_ID -N_idx $N_idx -train 1 -train_more 0 -train_steps "1e7" -sim 1 -sim_eps "5e3" -train_new_model 1 -training_version_start "20" -training_version_stop "40"
