...
def individual_action_plot(trials, nodes, t_cut, p, p_s, training_steps):
    ...
    # Show the plot
    plt.savefig(data_path+f'/figures/fig4_{training_steps}.pdf', dpi=1200)
    plt.savefig(data_path+f'/figures/fig4_{training_steps}.svg', dpi=1200)
...
def do_action_plots(trials, nodes, t_cut, p, p_s, training_steps_arr):
    ...
    for i, training_steps in enumerate(training_steps_arr):
        ...
        save_directory = data_path+f'/figures/fig4'
        if not os.path.exists(save_directory):
            os.makedirs(save_directory)
        plt.savefig(save_directory+f'/fig4_{training_steps}.jpg', dpi=1200)
        plt.savefig(save_directory+f'/fig4_{training_steps}.pdf', dpi=1200)
        plt.savefig(save_directory+f'/fig4_{training_steps}.svg', dpi=1200)
...
def do_action_plots_equal_size(trials, nodes, t_cut, p, p_s, training_steps_arr, trim=0):
    ...
    for i, training_steps in enumerate(training_steps_arr):
        ...
        if not os.path.exists(save_directory):
            os.makedirs(save_directory)
        plt.savefig(save_directory+f'/fig4_{training_steps}_filled.jpg', dpi=1200)
        plt.savefig(save_directory+f'/fig4_{training_steps}_filled.pdf', dpi=1200)
        plt.savefig(save_directory+f'/fig4_{training_steps}_filled.svg', dpi=1200)
